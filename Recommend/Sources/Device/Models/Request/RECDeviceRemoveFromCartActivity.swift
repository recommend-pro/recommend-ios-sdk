...
public final class RECDeviceRemoveFromCartActivity: RECDeviceActivity {
    ...
    public init(
        ...
        self.data = RECDeviceRemoveFromCartActivityData(
            cartHash: cartHash,
            sku: sku,
...
struct RECDeviceRemoveFromCartActivityData: Encodable {
    let cartHash: String
    let sku: String
